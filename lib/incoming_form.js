...
var util = require('util'),
    ...
    TextParser = require('./text_parser').TextParser,
...
IncomingForm.prototype._parseContentType = function() {
  if (!this.headers['content-type']) {
	...
	if (this.headers['content-type'].match(/text\/plain/i)) {
	    this._initTextPlain();
	    return;
	}
...
IncomingForm.prototype._initTextPlain = function() {
  this.type = 'text/plain';

  var parser = new TextParser()
    , self = this;

  parser.onText = function(val) {
    self.emit('text', val);
  };
